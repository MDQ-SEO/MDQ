...
<div class="col-lg-12">
    ...
    <!-- Filter Form -->
    <form method="GET" action="admin-contactus.php" class="row mb-3">
        ...
        <div class="col-md-3 d-flex align-items-end">
            ...
            <a href="admin-contactus.php" class="btn btn-secondary ms-2">Clear</a> <!-- Clear Button -->
        </div>
    </form>
            ...
            <table class="table css-serial text-white" style="background-color: #111420;">
                ...
                <tbody id="post_search">
                    ...
                    <tr id="<?php echo $data['id']; ?>" class="text-nowrap text-center">
                        ...
                        <td style="max-width: 150px; white-space: normal; word-wrap: break-word;"><?php echo htmlspecialchars($cdate); ?></td>
                        <td style="max-width: 150px; white-space: normal; word-wrap: break-word;"><?php echo htmlspecialchars($name); ?></td>
    ...
    ?>
                        ...
                        <td style="max-width: 300px;">
                            <div style="max-height: 150px; overflow-y: auto; white-space: normal;">
            ...
            <?php 
            $pr_query = "SELECT * FROM contact WHERE 1";
