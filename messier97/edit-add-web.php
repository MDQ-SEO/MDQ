                ...
                <div id="post" class="tabcontent">
                    ...
                    if (isset($_POST['postedit'])) {
                        ...
                        // while ($users = mysqli_fetch_array($result)) {
                            $stmt = $conn->prepare("SELECT p.id, p.cilent_id, p.weblogo_images, p.webbanner_images, p.webproject_overview, p.webphotos, p.technology, p.webproject_title, p.project_id FROM web_details p INNER JOIN project_list w ON w.id = p.cilent_id WHERE p.id = ?");
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <div class="d-flex pt-2 align-items-center justify-content-between">
                                    <p class="fs-4 card-text" style="color:#1C46A8; font-weight:600"> Project List Edit
                                    </p>
                                    <div class="fw-bold">
                                        <a href="table-add-web.php" class="nav-link align-middle px-0">
                                            <button class="btn" type="submit" name="switch"><img width="30" height="30"
                                                    src="https://img.icons8.com/ios-glyphs/200/ffffff/multiply.png"
                                                    alt="multiply" /></button>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div style='border-radius:1rem' class="card shadow px-3 py-3">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-lg-4 d-flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="py-1">
                                                        ...
                                                        <input class="form-control" type="file" name="weblogo_images"
                                                            value="<?php echo $users['weblogo_images']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-4 d-flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="py-1">
                                                        <label for="image" class="form-label">Update Banner
                                                            Image</label>
                                                        <input class="form-control" type="file" name="webbanner_images"
                                                            value="<?php echo $users['webbanner_images']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="py-1">
...
?>
                                                        ...
                                                        <div class="col-lg-4 d-flex">
                                                            <div class="d-flex align-items-center">
                                                                <div class="py-1">
                                                                    <label for="files" class="form-label">Update Slider
                                                                        Image</label>
                                                                    <input type="file" class="form-control text-clr"
                                                                        id="files" multiple="multiple"
                                                                        name="webphotos[]" accept="image/*" />
                                                                    <!-- Hidden input field to store the image filenames -->
                                                                    <input type="" id="hiddenPhotos" name="hiddenPhotos"
                                                                        value="<?php echo $users['webphotos']; ?>" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="py-1">
                                                                ...
                                                                <label for="name" class="form-label">Project Overview
                                                                    :</label>
                                                                <input type="text" name='webproject_overview'
                                                                    value='<?php echo $users['webproject_overview']; ?>'
                                                                    class="form-control" id="imgname"
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <select style="width: 100%;" name='technology[]'
                                                                class="multiple-select one py-2"
                                                                data-placeholder="Select" multiple
                                                                data-actions-box="true" size="3">
                                                                <?php
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $id; ?>">
                                                                    <?php echo $technologyname; ?></option>
                                                                <?php
                                                            } ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="py-1">
                                                                <label for="name" class="form-label"> Project Title
                                                                    :</label>
                                                                <input type="text" name='webproject_title'
                                                                    value='<?php echo $users['webproject_title']; ?>'
                                                                    class="form-control" id="imgname"
                                                                    placeholder="Enter the name">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class='text-center pt-2'>
                                                        <button type="submit" name='edit-post' style="width:100%"
