    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="row">
                    ...
                    <p class="fs-4 card-text" style="color:#1C46A8; font-weight:600"> Position Table</p>
                        <div class="fw-bold">
                        ...
                        <div class="table-responsive">
                            <div class="wrapper">
                                ...
                                <div class="text-center" style="background-color: #2d2e37;">
                                    ...
                                    $pr_query = "SELECT * FROM hire_position";
                                    ...
                                    if ($page > 1) {
                                        echo "<a href='admin-add-position.php?page=" . ($page - 1) . "' class='btn mx-2'>Previous</a>";
                                    }


                                    for ($i = 1; $i < $total_page; $i++) {
                                        echo "<a href='admin-add-position.php?page=" . $i . "' class='btn mx-1'>$i</a>";
                                    }

                                    if ($i > $page) {
                                        echo "<a href='admin-add-position.php?page=" . ($page + 1) . "' class='btn mx-2'>Next</a>";
                                    }
