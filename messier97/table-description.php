    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="row">
                    ...
                    <p class="fs-4 card-text" style="color:#1C46A8; font-weight:600">Job Description Table</p>
                        <div class="fw-bold">
                        ...
                        <div class="table-responsive">
                            <div class="wrapper">
                                    ...
                                    <tbody id="post_search">
                                        ...
                                        <tr id="<?php echo $data['id']; ?>" class="text-nowrap text-center">
                                            ...
                                            <td class='text-center'>
                                                <form action="delete-description.php" method="POST">
                                ...
                                <div class="text-center" style="background-color: #2d2e37;">
                                    ...
                                    $pr_query = "SELECT * FROM hire_description";
                                    ...
                                    if ($page > 1) {
                                        echo "<a href='admin-add-description.php?page=" . ($page - 1) . "' class='btn mx-2'>Previous</a>";
                                    }


                                    for ($i = 1; $i < $total_page; $i++) {
                                        echo "<a href='admin-add-description.php?page=" . $i . "' class='btn mx-1'>$i</a>";
                                    }

                                    if ($i > $page) {
                                        echo "<a href='admin-add-description.php?page=" . ($page + 1) . "' class='btn mx-2'>Next</a>";
                                    }
