...
<head>
    <meta name="description" content="Build secure healthcare apps and medical software with MDQuality Apps in Chennai, India. We develop telemedicine, hospital management, and patient care solutions." />
...
<div class="website-background" style="background-color: #F7FDFF; padding-top:95px">
    <div class="intro" style="background-color:#081A48">
        <h1 class="pt-4" style="color:white; text-align: center; font-weight:600">Transform healthcare with our professional solutions and expertise</h1>
