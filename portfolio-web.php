                ...
                <div class="row py-4">
                    <div class="col-lg-6">
                        ...
                        <h5 class="py-1">
                            <?php
                                        if ($prjpoints != null) {
                                            echo "<img src='images/portfolio/$images' alt='$images'  width='50px' height='50px'/>";
                                        }
                    ...
                    <div class="swiper-container">
                        ...
                        ?>
                            <div class="swiper-slide py-5 d-flex justify-content-center">
                                ...
                                <a href="portfolio-web.php?id=<?php echo $id; ?>"
                                    ...
                                    <div class=" port-animation-card">
                                        ...
                                        <img src="./images/portfolio/<?php echo $sec_image; ?>" width="280px"
