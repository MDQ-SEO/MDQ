...
<head>
<meta name="description" content="Manufacturing software development in Chennai, India by MDQuality Apps. Build smart factory apps, automation systems, and Industry 4.0 solutions for modern manufacturing." />
...
<div class="website-background" style="background-color: #F7FDFF; padding-top:95px">
    <div class="intro" style="background-color:#081A48">
        <h1 class="pt-4" style="color:white; text-align: center; font-weight:600">Optimize your manufacturing processes with our professional solutions and expertise</h1>
