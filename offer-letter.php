...
<head>
  ...
  <meta name="description" content="Looking to hire a dedicated developers team in India? Contact us for reliable and cost-effective solutions." />
  ...
  <meta property="og:description" content="Looking to hire a dedicated developers team in India? Contact us for reliable and cost-effective solutions." />
  <meta property="og:url" content="https://mdqualityapps.com/offer-letter.php" />
  ...
  <meta name="twitter:description" content="Looking to hire a dedicated developers team in India? Contact us for reliable and cost-effective solutions." />
  <meta name="twitter:title" content="Hire Top-rated Developers Team in India" />
            ...
            <form method="post" onsubmit="return checkInput()" action="./messier97/offer-letter-backend.php" enctype="multipart/form-data">
              ...
              <div class="container" style="text-align: end;">
                <fieldset>
                  ...
                  <div>
                    <input type="text" class="form__field field--name text-end fontbox fontstyle" id="floatingInput" placeholder="Current Location" name="location" value="" required>
                  </div>
                  <div>
                  ...
                  <input type="date" class="form__field field--name text-end fontbox fontstyle" id="floatingInput" placeholder="Enter Your DOB" name="dob" value="">
                  <!-- My name is  -->
              ...
              <div>
                ...
                <span class="fontstyle" style="color:white">I am writting this letter to apply for the position of <input type="text" class="form__field field--name text-end fontbox fontstyle" id="floatingInput" name="position" value="" placeholder="Enter the position" required> at your company. I am graduated from <input type="text" class="form__field field--name fontbox fontstyle" id="floatingInput" placeholder="Enter Your College Name" name="collname" value="" required> with a degree in
                  <select name="branch" class="form-select-lg orm__field field--name fontbox fontstyle" style="background: transparent; padding-left: 0.2rem !important; color: #081A48;" aria-label=".form-select-lg example" required style="font-size:15px" required onchange="updateTextColor(this)">
              ...
              <div class="row d-flex justify-content-center">
                ...
                <div>
                  ...
                  <span style="color:white" class="fontstyle d-flex justify-content-end">Regards,
                </div>
